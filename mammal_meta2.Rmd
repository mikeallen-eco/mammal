...
ggsave("figures/species_accumulation_curve_roll_soil2.png",
...
jags.data.multimethod <- list(y = y, 
                           n.trees = nrow(y), 
                           n.samps = ncol(y), 
                           n.device = dim(y)[3],
                           method = method, 
...
This is the primary analysis used in the manuscript, which treats the three 'suspected false positives' as negatives. Run time is approximately 30 seconds with parallel = T.
```{r}
# Initial values
y_no_na <- y
...
params <- c("gamma0", "beta0", "beta.method", "alpha0", "alpha.device")
            ...
            # "psi.vineyards", "theta.round1", "theta.round2",
            # "p.eDNA", "p.vis", "p_vineyard_eDNA_r1", "p_vineyard_eDNA_r2",
            # "p_vineyard_vis_r1", "p_vineyard_vis_r2", "n_eDNA_r1", "n_eDNA_r2",
            # "n_vis_r1", "n_vis_r2")
...
JAGS output for model 'scripts/mammal_multimethod.txt', generated by jagsUI.
...
MCMC ran in parallel for 0.309 minutes at time 2022-06-13 17:15:37.

               mean     sd   2.5%    50%  97.5% overlap0     f  Rhat n.eff
gamma0       -0.213  0.683 -1.333 -0.275  1.351     TRUE 0.681 1.002  5362
beta0        -1.086  1.161 -3.217 -1.149  1.400     TRUE 0.852 1.002  1677
beta.method   2.798  1.762  0.128  2.506  7.010    FALSE 0.981 1.000 12000
alpha0        0.021  0.810 -1.377 -0.066  1.852     TRUE 0.464 1.002   903
alpha.device -1.825  0.822 -3.558 -1.777 -0.337    FALSE 0.993 1.001  4192
deviance     46.584 11.828 24.489 47.157 70.153    FALSE 1.000 1.003   704
